...
public class UpdateDoctor implements Initializable {
    ...
    @FXML
    private ChoiceBox updatespecialite;
    @FXML
    ...
    private void initializeLabels(Doctor doctor) {
        try {
            ...
            updatespecialite.setValue(doctor.getSpecialite());
    ...
    private void handleUpdateButton(ActionEvent event) {
        ...
        String enteredspecialite = (String) updatespecialite.getValue();
        ...
        loggedInDoctor.setPhoto(imageName);
        loggedInDoctor.setSpecialite(enteredspecialite);
